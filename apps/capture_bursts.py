...
# Title: Capture Bursts
# Generated: Thu Nov 19 04:19:00 2015
##################################################
...
class capture_bursts(gr.top_block, Qt.QWidget):
...
if __name__ == '__main__':
    ...
    tb = capture_bursts(gain=options.gain, ppm=options.ppm, samp_rate=options.samp_rate, shiftoff=options.shiftoff, fc=options.fc)
    tb.start()
    tb.show()
    def quitting():
        tb.stop()
