...
# Generated: Wed Nov 25 05:58:36 2015
##################################################
...
if __name__ == '__main__':
    ...
    tb = airprobe_rtlsdr_nogui(fc=options.fc, shiftoff=options.shiftoff, ppm=options.ppm, gain=options.gain, samp_rate=options.samp_rate, device=options.device)
    tb.start()
    tb.wait()
