...
# Title: Tmsi Print Nogui
# Generated: Wed Nov 18 12:02:18 2015
##################################################
...
class tmsi_print_nogui(gr.top_block):
...
if __name__ == '__main__':
    ...
    tb = tmsi_print_nogui(fc=options.fc, shiftoff=options.shiftoff, ppm=options.ppm, gain=options.gain, samp_rate=options.samp_rate, device=options.device)
    tb.start()
    tb.wait()
